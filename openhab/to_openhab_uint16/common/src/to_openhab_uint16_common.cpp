...
class to_openhab_uint16_config
{
public:
    std::string key;
};

class to_openhab_uint16_data
{
...
class to_openhab_uint16_impl
{
    /* protected region user member variables on begin */
	to_openhab_uint16_config local_config;
...
public:
    ...
    void configure(to_openhab_uint16_config config) 
    {
    ...
    void update(to_openhab_uint16_data &data, to_openhab_uint16_config config)
    {
